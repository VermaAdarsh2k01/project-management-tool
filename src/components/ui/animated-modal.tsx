...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-4 py-6 rounded-md text-black dark:text-white text-center relative overflow-hidden hover:cursor-pointer",
        className
      )}
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[50%] xl:h-fit max-h-[90%] md:max-w-[60%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
