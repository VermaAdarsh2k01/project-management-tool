...
import { CheckSquare, MoreHorizontal, Calendar, ChevronDown, CalendarIcon, AlertTriangle } from 'lucide-react'
    ...
    <div className="w-full flex flex-col justify-evenly h-full ">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex-1">
          <h2 className="text-xl lg:text-lg font-semibold">New task</h2>
        </div>
      </div>
